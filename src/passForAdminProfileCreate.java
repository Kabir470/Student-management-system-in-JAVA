...
public class passForAdminProfileCreate extends JFrame implements ActionListener {
    JButton back,enter;
    JPasswordField passwordField;
    JRadioButtonMenuItem showpass;
    String mainPassword= "87654321";

    passForAdminProfileCreate(){
        setLayout(null);
        ...
        if(ae.getSource()==enter) {
            try {
                if (spassword.equals("")) {
                    ...
                    setVisible(false);
                    new adminCreateProfile().setVisible(true);
                }
