...
public class enterStudentMarks extends JFrame implements ActionListener {
    ...
    enterStudentMarks() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/globe 2.jpg"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            try {
                cnction c = new cnction();
                String query1 = "insert into subject values('"+IDno.getSelectedItem()+"', '"+cbsemester.getSelectedItem()+"', '"+tfsub1.getText()+"', '"+tfsub2.getText()+"', '"+tfsub3.getText()+"', '"+tfsub4.getText()+"', '"+tfsub5.getText()+"')";
                String query2 = "insert into marks values('"+IDno.getSelectedItem()+"', '"+cbsemester.getSelectedItem()+"', '"+tfmarks1.getText()+"', '"+tfmarks2.getText()+"', '"+tfmarks3.getText()+"', '"+tfmarks4.getText()+"', '"+tfmarks5.getText()+"')";
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(null, "Please enter the valid marks and semester");
            }
        } else {
            setVisible(false);
        }
