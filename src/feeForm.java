...
public class feeForm extends JFrame implements ActionListener {
    ...
    feeForm() {
        ...
        String branch[] = {"Computer Science", "Electronics", "Mechanical", "Civil","Law", "IT","None listed"};
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                cnction c = new cnction();
                String query = "select fee_amount from fee where course = '"+course+"' and semester = '"+semester+"'";
                ResultSet rs = c.s.executeQuery(query);
                if(rs.next()) {
            ...
            String ID = IDno.getSelectedItem();
            String course = (String) cbcourse.getSelectedItem();
            String semester = (String) cbsemester.getSelectedItem();
            ...
            try {
                ...
                String query = "insert into feeForm values('"+ID+"', '"+course+"', '"+branch+"', '"+semester+"', '"+total+"')";
